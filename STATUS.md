...
**The repository is complete for its stated scientific result.** It contains the precise channel model and theorem, the complete internal proof, the computer-assisted certificate with three independent verification implementations, the eight-use witness, and all three figures with their data and captions.

For every permitted finite full-span measurement ensemble and every common symmetric reporting error strictly between zero and one half, the result gives a nonempty measurement-probability interval with globally optimized single-use coherent information equal to zero and positive asymptotic quantum capacity. [Exact theorem and assumptions](docs/MODEL_AND_CLAIMS.md#m04) · [Complete proof](docs/COMPLETE_PROOF.md)
...
A manuscript is not included. Preparing one is a separate writing stage; the repository supplies the scientific argument and supporting material in full.
